            ...
            <div className="container py-8 md:py-12">
                <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">Expert in Generative AI and Agentic AI</p>
                    </div>
                ...
                <div className="mt-8 grid grid-cols-1 gap-8 border-t pt-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            ...
                            <li>
                                <Link href="https://github.com/pr1m8" className="text-muted-foreground hover:text-foreground">
                                    GitHub
                                </Link>
                            </li>
                            <li>
                                <Link href="https://pypi.org/user/wrastley/" className="text-muted-foreground hover:text-foreground">
                                    PyPI Packages
                                </Link>
                            </li>
                        </ul>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            <li>
                                <CopyToClipboard text="wrastley@gmail.com" className="block">
                                    <Link href="mailto:wrastley@gmail.com" className="text-muted-foreground hover:text-foreground">
                                        wrastley@gmail.com
                                    </Link>
                                </CopyToClipboard>
                            </li>
                            <li>
                                <CopyToClipboard text="(518) 902 5805" className="block">
                                    <span className="text-muted-foreground hover:text-foreground cursor-pointer">(518) 902 5805</span>
                                </CopyToClipboard>
                            </li>
                            <li>
                                <Link
                ...
                <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
                    <p>© {new Date().getFullYear()} William Astley. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
