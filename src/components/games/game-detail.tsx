      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-3xl font-bold">{game.stats.totalGames.toLocaleString()}</div>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-3xl font-bold">{game.stats.avgMovesPerGame}</div>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-3xl font-bold">{game.stats.topPerformers.length}</div>
                ...
                <div key={index} className="p-4 rounded-lg bg-muted/50 space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span className="font-semibold text-lg">{result.player1}</span>
                      <span className="text-muted-foreground font-medium">vs</span>
                      <span className="font-semibold text-lg">{result.player2}</span>
                    </div>
                    <Badge 
                      variant={result.winner === result.player1 ? "default" : "secondary"}
                      className="text-sm"
                    >
                      {result.winner} wins
                    </Badge>
