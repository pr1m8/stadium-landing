...
const leaderboardData = [
  {
    ...
    author: { name: "Alex Chen", avatar: "/assets/avatars/alex.jpg" },
    score: "9.8",
    cost: "0.07",
    latency: "2.8",
    successRate: "94",
  ...
  },
  {
    ...
    author: { name: "Maria Rodriguez", avatar: "/assets/avatars/maria.jpg" },
    score: "9.5",
    cost: "0.09",
    latency: "3.1",
    successRate: "92",
  ...
  },
  {
    ...
    author: { name: "Michael Johnson", avatar: "/assets/avatars/michael.jpg" },
    score: "9.2",
    cost: "0.12",
    latency: "2.5",
    successRate: "88",
  ...
  },
  {
    ...
    author: { name: "Sophia Kim", avatar: "/assets/avatars/sophia.jpg" },
    score: "9.1",
    cost: "0.09",
    latency: "3.1",
    successRate: "91",
  ...
  },
  {
    ...
    author: { name: "David Lee", avatar: "/assets/avatars/david.jpg" },
    score: "8.9",
    cost: "0.15",
    latency: "3.6",
    successRate: "93",
  ...
  },
  {
    ...
    author: { name: "Emma Wilson", avatar: "/assets/avatars/emma.jpg" },
    score: "8.7",
    cost: "0.11",
    latency: "2.9",
    successRate: "89",
  ...
  },
  {
    ...
    author: { name: "James Taylor", avatar: "/assets/avatars/james.jpg" },
    score: "8.5",
    cost: "0.13",
    latency: "3.4",
    successRate: "87",
  ...
  },
  {
    ...
    author: { name: "Olivia Brown", avatar: "/assets/avatars/olivia.jpg" },
    score: "8.3",
    cost: "0.08",
    latency: "3.0",
    successRate: "85",
  ...
  },
  {
    ...
    author: { name: "Noah Garcia", avatar: "/assets/avatars/noah.jpg" },
    score: "8.1",
    cost: "0.10",
    latency: "3.2",
    successRate: "84",
  ...
  {
    name: "Plan-and-Solve",
    author: { name: "Ava Martinez", avatar: "/assets/avatars/ava.jpg" },
    score: "8.0",
    cost: "0.09",
    latency: "2.7",
    successRate: "82",
      ...
      <section className="w-full min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <HeroHighlight className="w-full max-w-6xl flex flex-col items-center justify-center text-center gap-8 py-24 px-4 z-10">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-4">
            Stop <Highlight className="text-primary">Rewriting</Highlight>.{" "}
            Start <Highlight className="text-accent">Benchmarking</Highlight>.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 mt-12">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-secondary text-secondary hover:bg-secondary/10 min-w-[200px]"
            >
              Join Competition
            </Button>
          </div>
