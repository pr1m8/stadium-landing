...
const PR1M8_PROJECTS: DocProject[] = [
  {
    ...
    description:
      "Documentation for the NAS framework including tutorials, API reference, and examples.",
  ...
  },
  {
    ...
    description:
      "Comprehensive guide to using transformer models for time series forecasting.",
  ...
  },
  {
    ...
    description:
      "Documentation for implementing RL in financial risk management applications.",
  ...
  },
  {
    ...
    description:
      "Guide to combining data from multiple modalities for comprehensive AI understanding.",
  ...
  },
  {
    ...
    description:
      "Documentation for the Dynamic Retrieval Augmented Generation framework.",
...
export async function fetchReadTheDocs(
  username = "pr1m8",
  limit = 3,
): Promise<DocProject[]> {
